 ...
 * the firephp-class must be in your include-path!
 *
 * If you get strange errors like 'Unknown Exception in line 0' or
 * 'only one table at a time shows up': blame firephp and update to
 * a newer version
 *
