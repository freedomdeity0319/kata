...
class LocaleComponent {
	...
	function getString($id, $messageArgs= null) {
		...
		if (defined('LANGUAGENOTPRINTF') && (LANGUAGENOTPRINTF)) {
			$replaced= 0;
			...
			return vsprintf($ret, (null === $messageArgs?array():$messageArgs));
		}

		if (defined('CLICK2TRANSLATE') && (CLICK2TRANSLATE) && !empty($_GET['c2t'])) {
...
*/
			...
			if (function_exists('setlocale')) {
				setlocale(LC_ALL, $this->getLanguageFromTld($code));
			}
		}
	}
