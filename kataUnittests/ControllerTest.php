...
class ControllerTest  extends kataTestBaseClass {
	//TODO benötigt schreibRechte auf controllers/view ordner
	private $myModel ;
	...
	function testGetSet(){
		//TODO get und setTitle unnötig da über get(title) und set(title) ausgelöst wird.
	...
	function testRenderCachedHtml(){
		//ToDo Name irreführend RenderCachedHTML erinnert eher an ein im Cache liegende View...es wird der Cache aber nicht ausgewertet.
		//besser RenderHTML
		//ToDo eventuell eine weitere Funktion implementieren, welche eine View Rendert aber nicht before und afterFilter triggert.
		// z.B. benötigt bei ajax requests wenn Layout==null! ... da der AppController in seinem beforeFilter einen Loca Key sucht welcher der Title der Seite sein soll ... aber ein Ajax request braucht eigentlich keinen Title...
		$myMockController = &new MockController();
		$myMockController->set("name","AngryBeaver");
		$return = $myMockController->renderCachedHtml("AngryBeaver",null);
		//ToDO falsche Beschreibung "and put the result in the output-property of this controller."
		//gerenderte View ist nicht im OutputController.
