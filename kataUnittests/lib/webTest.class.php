...
class webTestClass extends WebTestCase {
	 ...
	 * die neue Seite wird auf validität überprüft
	 *
	 * @see  parent::get();
	 * @see validatePage();
	 */
	 ...
	 * @param array $parameter überschreibt/setzt weitere post parameter
	...
	/**
	 * überprüft die momentane Seite auf standard Fehler, z.B. ob Fatal error: als Text enthalten ist.
	 */
	 ...
	 * @param string $url die zu verändernde url
	 * @param array $parameters die zu ersetzenden/erweiternden parameter
	 * @return string veränderte url
	 */
	...
	/**
	 * gibt aus einer Url alle Get Parameter zurück
	...
	/**
	 * zerlegt eine Url in einzelteile und gibt diese zurück
	 * @param string $url die zu untersuchende url
	...
	/**
	 * überprüft ob der url string in der momentan gelandeten url enthalten ist
	 * @param string $url ein teil der erwarteten url
	 * @param array $parameter Liste an getParametern die in der gelandeten url enthalten sein müssen
	 */
	...
	* Gibt false zurück wenn DOMNodeListe leer ist.
	*
	* Besonderheiten:
	* Key = "attributeName &" bedeutet das der ursprüngliche inhalt erweitert wird
	* Key = "attributeName !" bedeutet das aus dem ursprüngliche inhalt jedes vorkommen des values entfernt wird
	...
	* @return boolean gibt false zurück wenn DOMNodeListe leer ist.
	**/
	...
	/**
	* für jedes Key=>Value Element in Attributes wird ein attribut mit dem namen des Keys gesucht welches den Inhalt Value hat.
	* Wirkt sich nicht auf $this->browser aus.
	*
	* Besonderheiten:
	*	Key = innerText bedeutet der textuelle Innhalt zwischen den Nodes
	*	nachfolgende Operatoren im Key werden unterstützt
	...
	* @param array $elemnts Rückgabewert enthält eine Liste mit unterschiedlichen Elementen die durch Elemente erweitert wird, welche dem Filter genügen
	**/
	...
	/**
	 * gibt eine Liste an Elementen zurück welche sich innerhalb einer Liste an Elementen befinden und die definierten Attribute besitzen.
	 * Wirkt sich nicht auf $this->browser aus.
	 *
	 * @param string $tag nodeName der Elemente die man möchte
	 * @param array $attributes Liste an Attributen, die die Elemente besitzen müssen
	 * @param DOMNodeList $inElements Liste an Elementen welche die gesuchten Elemente besitzen
	 * @param boolean $inner bei true werden Elemente aus der $inElements Liste zurückgegeben welche entsprechende Elemente enthalten.
	...
	/**
	 * gibt eine Liste an Attributwerten für definiertes Attribut der definierten Elemente wieder.
	 *
	 *
