...
/**
 * A component for object oriented session handling using encrypted client-side cookies.
 * keep in mind: this cookie is very big and is sent on EVERY request!
 * 
...
class SessionComponent extends baseSessionComponent {
	...
	protected function encodeSession() {
		...
		$data = base64_encode(gzdeflate(serialize($this->sessionData)));
		unset ($this->sessionData['Config.hash']);
